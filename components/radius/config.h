#ifndef __RADIUS_CONFIG_H__
#define __RADIUS_CONFIG_H__
...
#define RC_LOG_FACILITY LOG_AUTH
...
//static struct servent * getservbyname( const char * name, const char * proto ) {return 0;}
#define getservbyname(name, proto) (NULL)
#define NI_NUMERICHOST 0

#endif //__RADIUS_CONFIG_H__
